	                                ...
	                                <div class="table-responsive">
					                    ...
					                    <tbody>
						                    ...
						                    <tr>
						                        ...
						                        <td>
                                                    <div class="btn-group">
						                        	<button class="btn btn-success dim" onclick="location.href='<?php echo site_url('daftar_transaksi/detail_transaksi/'.$dt['id_transaksi'].'/'.$dt['id_jenis_mobil'])?>'" type="button"><i class="fa fa-eye"></i></button>
                            						<button class="btn btn-info dim" onclick="location.href='<?php echo site_url('daftar_transaksi/konfirmasi_transaksi/'.$dt['id_transaksi'].'/'.$dt['id_jenis_mobil'])?>'" type="button" <?php if($dt['status'] != 0) echo 'disabled' ?>><i class="fa fa-wrench"></i> </button>
                                                    <button class="btn btn-primary dim" onclick="if (confirm('Proses transaksi akan dianggap selesai, apakah Anda yakin?')) location.href='<?php echo site_url('daftar_transaksi/selesai/'.$dt['id_transaksi'])?>'" type="button" <?php if($dt['status'] != 1) echo 'disabled' ?>><i class="fa fa-check"></i> </button>
                                                    </div>
						                        </td>
						                    </tr>
						                    <?php } ?>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-sm-4">
                                    <button class="btn btn-warning btn-circle" type="button">X</button> : Sedang Dalam Proses Konfirmasi Admin 
                                </div>
                                <div class="col-sm-4">
                                    <button class="btn btn-info btn-circle" type="button"><i class="fa fa-bus"></i></button> : Sedang Dalam Proses Pengiriman Kurir
                                </div>
                                <div class="col-sm-4">
                                    <button class="btn btn-primary btn-circle" type="button"><i class="fa fa-check"></i></button> : Transaksi Selesai
                                </div>
                            </div>
                        </div>
                    </div>
