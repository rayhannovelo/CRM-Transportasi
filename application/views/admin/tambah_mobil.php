...
<head>
    ...
    <title>PT. Transportasi | TAmbah Mobil</title>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Form Tambah Mobil</h5>
                        </div>
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form class="form-horizontal" role="form" action="<?php echo site_url('daftar_mobil/tambah_mobil_form'); ?>" method="post"  enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <?php if($daftar_jenis_mobil != NULL) foreach($daftar_jenis_mobil as $djm) { ?>
                                                <option value="<?php echo $djm['id_jenis_mobil'] ?>"><?php echo $djm['nama_jenis'] ?></option>
                                            <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="plat_nomor" placeholder="Plat Nomor" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Merk :</label>
                                        <div class="col-lg-9">
                                            <input type="text" name="merk" placeholder="Merk Mobil" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Warna :</label>
                                        <div class="col-lg-9">
                                            <input type="text" name="warna" placeholder="Warna Mobil" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Tahun Pembuatan :</label>
                                        <div class="col-lg-9">
                                            <input type="number" name="tahun_pembuatan" placeholder="Tahun Pembuatan" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <div class="fileinput fileinput-new col-sm-9" data-provides="fileinput">
                                                ...
                                                <div>
                                                  <span class="btn btn-default btn-file"><span class="fileinput-new">Pilih Foto</span>
                                                    ...
                                                    <input type="file" name="foto_mobil" accept="image/*" required>
                                                  </span>
