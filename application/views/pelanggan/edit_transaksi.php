...
<head>
    ...
    <title>PT. Transportasi | Edit Transaksi</title>
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <form class="form-horizontal" role="form" action="<?php echo site_url('transaksi/edit_transaksi_form')?>" method="post" onsubmit="return confirm('Data transaksi akan diupdate. Apakah Anda yakin?');">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <select name="id_jenis_mobil" class="form-control" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="lokasi_tujuan" placeholder="Lokasi Tujuan" class="form-control" value="<?php echo $t['lokasi_tujuan']; ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group date">
                                                <input id="date_added" name="tanggal_pengiriman" placeholder="YYYY-MM-DD" type="text" class="form-control" value="<?php echo $t['tanggal_pengiriman']; ?>" required><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <textarea type="text" id="summernote" name="deskripsi" class="form-control" required=""><?php echo $t['deskripsi']; ?></textarea> 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <tbody>
                                                <?php $x = 1; if($daftar_barang != NULL) foreach($daftar_barang as $db) { ?>
                                                <tr>
                                                    <td>
                                                        <input type="hidden" name="id_daftar_barang[]" value="<?php echo $db['id_daftar_barang']; ?>">
                                                        <input type="text" name="nama_barang[]" placeholder="Nama Barang" class="form-control" value="<?php echo $db['nama_barang']; ?>" required>
                                                    </td>
                                                    <td>
                                                        <input type="text" name="keterangan[]" placeholder="Keterangan Barang" class="form-control" value="<?php echo $db['keterangan']; ?>" required>
                                                    </td>
                                                    <td>
                                                        <input type="number" name="kuantitas[]" placeholder="Kuantitas" class="form-control" value="<?php echo $db['kuantitas']; ?>" required>
                                                    </td>
                                                    <td>
                                                        <center><button type="button" class="btn btn-s btn-danger" <?php if($x == 1) echo 'disabled'; ?> onclick="if (confirm('Barang transaksi akan dihapus, apakah Anda yakin?')) location.href='<?php echo site_url('transaksi/hapus_barang_transaksi/'.$db['id_daftar_barang'].'/'.$t['id_transaksi'])?>'" ><i class="fa fa-trash"></i></button></center>
                                                    </td>
                                                </tr>
        ...
        $(document).ready(function(){
            ...
            $(document).on("click",'button#tambah_barang',function(){
                ...
                $('#myTable').append(
                    '<tr id="barang'+barang+'">'+
                        '<td>'+
                            '<input type="hidden" name="id_daftar_barang[]" value="0">'+
