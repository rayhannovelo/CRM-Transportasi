...
<head>
    ...
    <title>PT. Transportasi | Profil</title>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div id="page-wrapper" class="gray-bg">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" name="nama_pelanggan" class="form-control" value="<?php echo $p['nama_pelanggan']; ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label">No Telepon :</label>
                                                <div class="col-lg-9">
                                                    <input type="text" name="no_telp" class="form-control" value="<?php echo $p['no_telp']; ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label">FAX :</label>
                                                <div class="col-lg-9">
                                                    <input type="text" name="fax" class="form-control" value="<?php echo $p['fax']; ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
            ...
            <div class="footer">
                ...
                <div>
                    <strong>Copyright</strong> Dinas Pariwisata Kabupaten Lahat &copy; 2017
                </div>
            </div>
