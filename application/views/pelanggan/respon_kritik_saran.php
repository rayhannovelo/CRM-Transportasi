...
<head>
    ...
    <title>PT. Transportasi | Respon Kritik Saran</title>
...
<body class="skin-1" onload="start();">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Waktu Kritik Saran :</label>
                                        <div class="col-lg-9 form-control-static">
    ...
    <script>
        ...
        function loadChat() {
                    ...
                    for(var i = 0; i < objek.length; i++) {
                        if(objek[i].id_users != '1') {
                            ...
                            '<div class="chat-message left">'+
                                ...
                                '<div class="message">'+
                                    '<a class="message-author" href="#"> <?php echo $this->session->userdata('nama_pelanggan'); ?> </a>'+
            ...
            xmlhttp.open("GET","<?php echo site_url('kritik_saran/ambil_respon_kritik_saran/'.$this->uri->segment(3).'/')?>" + last, true);
            xmlhttp.send();
        }
        ...
        function sendChat() {
            ...
            xmlhttp_kirim.open("GET","<?php echo site_url('kritik_saran/tambah_respon_kritik_saran/'.$this->uri->segment(3).'/')?>"+ document.getElementById('respon').value, true);
            xmlhttp_kirim.send();
        }
    </script>
</body>
