        ...
        <div class="wrapper wrapper-content">
	        <div class="row">
	            <div class="col-lg-3" style="margin: 0px 10px; text-transform: none;">
	                <button class="btn btn-primary btn-rounded btn-block dim" style="text-transform: none;" type="button" onclick="location.href='<?php echo site_url('kritik_saran/tambah_kritik_saran')?>'"><i class="fa fa-plus"></i> Tambah Kritik Saran</button>
	            </div>
                <div class="col-lg-8">
